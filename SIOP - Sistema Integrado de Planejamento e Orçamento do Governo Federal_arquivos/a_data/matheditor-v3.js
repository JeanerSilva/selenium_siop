function MathEditor(id){
    ...
    this.default_toolbar_buttons = ["fração","raiz quadrada","raiz cúbica","raiz",'sobrescrito','subscrito','parenteses', 'colchetes', 'chaves', 'multiplicação','divisão', 'adição','subtração','igualdade', "maior ou igual", "menor ou igual", 'somatório', "produtório", "união", "delta", "logaritmo", "logaritmo neperiano", "alfa", "beta", "gama", "beta", "epsilon", "zeta", "eta", "teta", "iota", "capa", "lambda", "mi", "ni", "csi", "pi", "ró", "sigma", "tau", "upsilon", "fi", "chi", "psi", "omega"];
    /**this.default_toolbar_tabs = ["Geral","Caracteres gregos"];
    button_meta = {
		"fração": {latex: "\\frac{}{}", moveto: "Up", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-fracao.png'}, 
		"raiz quadrada": {latex: "\\sqrt{}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-raiz-quadrada.png'}, 
		"raiz cúbica": {latex: "\\sqrt[3]{}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-raiz-cubica.png'}, 
		"raiz": {latex: "\\sqrt[{}]{}", moveto: "Left", movefor: 2, tab: 1, icon:'_math_editor/icones/ico-raiz-n.png'}, 
		"sobrescrito": {latex: "\\^{}", moveto: "Up", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-potencia.png'}, 
		"subscrito": {latex: "\\_{}", moveto: "Down", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-subscrito.png'}, 
		"parenteses": {latex: "\\left(\\right)",moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-parenteses.png'}, 
		"colchetes": {latex: "\\left[\\right]",moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-colchete.png'}, 
		"chaves": {latex: "\\left\\{\\right\\}",moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-chaves.png'}, 
		"multiplicação": {latex: "\\times", tab: 1, icon:'_math_editor/icones/ico-multiplicacao.png'}, 
		"divisão": {latex: "\\div", tab: 1, icon:'_math_editor/icones/ico-divisao.png'}, 
		"adição": {latex: "+", tab: 1, icon:'_math_editor/icones/ico-adicao.png'}, 
		"subtração": {latex: "-", tab: 1, icon:'_math_editor/icones/ico-subtracao.png'}, 
		"igualdade": {latex: "=", tab: 1, icon:'_math_editor/icones/ico-igualdade.png'}, 
		"somatório": {latex: "\\sum", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-somatorio.png'}, 
		"alfa": {latex: "\\alpha", tab: 2, icon:'\\alpha'},
		"beta": {latex: "\\beta", tab: 2, icon:'\\beta'},
		"gama": {latex: "\\gamma", tab: 2, icon:'\\gamma'},
		"beta": {latex: "\\beta", tab: 2, icon:'\\beta'},
		"epsilon": {latex: "\\epsilon", tab: 2, icon:'\\epsilon'},
		"zeta": {latex: "\\zeta", tab: 2, icon:'\\zeta'},
		"eta": {latex: "\\eta", tab: 2, icon:'\\eta'},
		"teta": {latex: "\\theta", tab: 2, icon:'\\theta'},
		"iota": {latex: "\\iota", tab: 2, icon:'\\iota'},
		"capa": {latex: "\\kappa", tab: 2, icon:'\\kappa'},
		"lambda": {latex: "\\lambda", tab: 2, icon:'\\lambda'},
		"mi": {latex: "\\mu", tab: 2, icon:'\\mu'},
		"ni": {latex: "\\nu", tab: 2, icon:'\\nu'},
		"csi": {latex: "\\xi", tab: 2, icon:'\\xi'},
		"pi": {latex: "\\pi", tab: 2, icon:'\\pi'},
		"ró": {latex: "\\rho", tab: 2, icon:'\\rho'},
		"sigma": {latex: "\\sigma", tab: 2, icon:'\\sigma'},
		"tau": {latex: "\\tau", tab: 2, icon:'\\tau'},
		"upsilon": {latex: "\\upsilon", tab: 2, icon:'\\upsilon'},
		"fi": {latex: "\\phi", tab: 2, icon:'\\phi'},
		"chi": {latex: "\\chi", tab: 2, icon:'\\chi'},
		"psi": {latex: "\\psi", tab: 2, icon:'\\psi'},
		"omega": {latex: "\\omega", tab: 2, icon:'\\omega'}**/
		
		this.default_toolbar_tabs = ["Geral"];
		button_meta = {
		"fração": {latex: "\\frac{}{}", moveto: "Up", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-fracao.png'}, 
		"raiz quadrada": {latex: "\\sqrt{}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-raiz-quadrada.png'}, 
		"raiz cúbica": {latex: "\\sqrt[3]{}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-raiz-cubica.png'}, 
		"raiz": {latex: "\\sqrt[{}]{}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-raiz-n.png'}, 
		"sobrescrito": {latex: "\\^{}", moveto: "Up", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-potencia.png'}, 
		"subscrito": {latex: "\\_{}", moveto: "Down", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-subscrito.png'}, 
		"parenteses": {latex: "\\left(\\right)",moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-parenteses.png'}, 
		"colchetes": {latex: "\\left[\\right]",moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-colchete.png'}, 
		...
		"subtração": {latex: "-", tab: 1, icon:'_math_editor/icones/ico-subtracao.png'}, 
		"igualdade": {latex: "=", tab: 1, icon:'_math_editor/icones/ico-igualdade.png'}, 
		"maior ou igual": {latex: "\\geq", tab: 1, icon:'_math_editor/icones/ico-maior-igual.png'}, 
		"menor ou igual": {latex: "\\leq", tab: 1, icon:'_math_editor/icones/ico-menor-igual.png'},
		"somatório": {latex: "\\sum", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-somatorio.png'}, 
		"produtório": {latex: "\\prod", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-produtorio.png'}, 
		"união": {latex: "\\bigcup", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-uniao.png'}, 
		"delta": {latex: "\\Delta", tab: 1, icon:'_math_editor/icones/ico-deltra.png'}, 
		"logaritmo": {latex: "\\log_{} {}", moveto: "Left", movefor: 1, tab: 1, icon:'_math_editor/icones/ico-logaritmo.png'}, 
		"logaritmo neperiano": {latex: "\\ln {}", moveto: "Right", movefor: 2, tab: 1, icon:'_math_editor/icones/ico-logaritmo-neperiano.png'},
		"alfa": {latex: "\\alpha", tab: 1, icon:'\\alpha'},
		"beta": {latex: "\\beta", tab: 1, icon:'\\beta'},
		"gama": {latex: "\\gamma", tab: 1, icon:'\\gamma'},
		"beta": {latex: "\\beta", tab: 1, icon:'\\beta'},
		"epsilon": {latex: "\\epsilon", tab: 1, icon:'\\epsilon'},
		"zeta": {latex: "\\zeta", tab: 1, icon:'\\zeta'},
		"eta": {latex: "\\eta", tab: 1, icon:'\\eta'},
		"teta": {latex: "\\theta", tab: 1, icon:'\\theta'},
		"iota": {latex: "\\iota", tab: 1, icon:'\\iota'},
		"capa": {latex: "\\kappa", tab: 1, icon:'\\kappa'},
		"lambda": {latex: "\\lambda", tab: 1, icon:'\\lambda'},
		"mi": {latex: "\\mu", tab: 1, icon:'\\mu'},
		"ni": {latex: "\\nu", tab: 1, icon:'\\nu'},
		"csi": {latex: "\\xi", tab: 1, icon:'\\xi'},
		"pi": {latex: "\\pi", tab: 1, icon:'\\pi'},
		"ró": {latex: "\\rho", tab: 1, icon:'\\rho'},
		"sigma": {latex: "\\sigma", tab: 1, icon:'\\sigma'},
		"tau": {latex: "\\tau", tab: 1, icon:'\\tau'},
		"upsilon": {latex: "\\upsilon", tab: 1, icon:'\\upsilon'},
		"fi": {latex: "\\phi", tab: 1, icon:'\\phi'},
		"chi": {latex: "\\chi", tab: 1, icon:'\\chi'},
		"psi": {latex: "\\psi", tab: 1, icon:'\\psi'},
		"omega": {latex: "\\omega", tab: 1, icon:'\\omega'}
 };
	...
	if(document.getElementsByClassName("latex-field").length > 0){
		document.getElementsByClassName("latex-field")[0].style.display = "none";
		config = {
			handlers: {
			  edit: function() {
				  var latexMath = myEditor.getLatex();
				  var latexField = document.getElementsByClassName("latex-field")[0];
				  latexField.value = latexMath;
			  },
			  enter: function() {},
			}
		};
...
MathEditor.prototype.styleMe = function(options){
	...
	var answerSpanWidth = parseInt(options.width) - 20;
	jq(this.answerSpan).css('background',options.textarea_background).css('color',options.textarea_foreground).css('border-color',options.textarea_border).css('width', answerSpanWidth).css('min-width',answerSpanWidth).css('min-height',options.height);
...
setToolbar = function(btns,answer_span,answer_math_field,top_elements,tabs,tabEnabled,isMobile){
        ...
        required_tabs.forEach(function(o,idx){
            ...
            required_buttons.forEach(function(b){
                if(button_meta[b].tab == idx+1){					
                    if(button_meta[b]){
						var icone = "";
						if(button_meta[b].icon.substr(0, 1) == "\\"){
							icone = button_meta[b].icon;
						}
						else{						
							icone = "<img src='"+button_meta[b].icon+"' />";
						}
					
                        html+="<span class='matheditor-btn-span'><i title='"+b.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}).replace('_',' ')+"' data-latex='"+button_meta[b].latex+"' data-moveto='"+button_meta[b].moveto+"' data-movefor='"+button_meta[b].movefor+"' id='matheditor-btn-"+b+"' class='op-btn'><span id='selectable-"+b+"-"+editor_id+"' class='op-btn-icon'>"+icone+"</span></i></span>";
                    }else{
	...
	required_buttons.forEach(function(b,idx){
        if(button_meta[b] && button_meta[b].icon.substr(0, 1) == "\\"){
